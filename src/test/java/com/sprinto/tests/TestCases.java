...
public class TestCases extends BaseClass {
	...
	public void TestCase_01() throws InterruptedException {
		...
		//Step 5 & 6 :- Click on "DATES&DURATION." and Select "December 2024" and adjust the duration to 10 days.
        ...
        List<String> datesBelowMedian = destinationPickerPage.getDatesWithPricesBelowMedian(flightPrices, flightDates, medianPrice);
        
        //Step 9 & 10:- select a weekend date (Saturday or Sunday), if available. If a weekend date is not available, choose the date with the lowest price.
        String selectedDate = destinationPickerPage.selectWeekendOrLowestPriceDate(datesBelowMedian, flightPrices);
        
        //Step 11 :- Verify that at least one flight is available for the selected date.
        boolean isFlightAvailable = destinationPickerPage.isFlightAvailableForDate(selectedDate);
        AssertJUnit.assertTrue(isFlightAvailable);
